...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "border-2 border-transparent py-1.5 pr-8 pl-2 text-xs font-bold text-mtext/80",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full text-mtext cursor-default select-none items-center rounded-base border-2 border-transparent py-1.5 pl-2 pr-8 text-sm font-base outline-none focus:border-border data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
